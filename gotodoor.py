...
class GoToDoorEnv(MiniGridEnv):
    ...
    def _gen_grid(self, width, height):
        ...
        width = self._rand_int(5, widt h +1)
        height = self._rand_int(5, heigh t +1)
        ...
        doorPos = []
        doorPos.append((self._rand_int(2, widt h -2), 0))
        doorPos.append((self._rand_int(2, widt h -2), heigh t -1))
        doorPos.append((0, self._rand_int(2, heigh t -2)))
        doorPos.append((widt h -1, self._rand_int(2, heigh t -2)))
